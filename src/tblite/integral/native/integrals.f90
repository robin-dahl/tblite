...
module tblite_integral_native_integrals
   ...
   use tblite_integral_diat_trafo, only: diat_trafo_cache, setup_diat_trafo, &
      & diat_trafo
   use tblite_integral_handler, only : maxl, maxl2, msao, mlao, smap, lmap, sdim, lx
   use tblite_integral_trafo, only : transform0, transform1, transform2
   implicit none
   private

   public :: get_overlap, overlap_1d, overlap_cgto, overlap_grad_cgto
   public :: dipole_3d, dipole_grad_cgto
