...
set("TBLITE_WITH_LIBCINT" @TBLITE_WITH_LIBCINT@)
...
set("TBLITE_USE_MOIST" @TBLITE_USE_MOIST@)
set("TBLITE_USE_DDX" @TBLITE_USE_DDX@)
set("TBLITE_USE_LIBCINT" @TBLITE_USE_LIBCINT@)
...
if(NOT TARGET "@PROJECT_NAME@::@PROJECT_NAME@")
  ...
  if(NOT TARGET "cint::cint" AND TBLITE_USE_LIBCINT)
    find_dependency("cint")
  endif()
  ...
  if(NOT TARGET "moist::moist" AND TBLITE_USE_MOIST)
    find_dependency("moist")
  endif()
